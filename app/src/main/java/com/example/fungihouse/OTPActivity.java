...
public class OTPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonOtp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                || inputCode6.getText().toString().trim().isEmpty()) {
                    Toast.makeText(OTPActivity.this, "Masukan Kode yang Sesuai", Toast.LENGTH_SHORT).show();
                    return;
                }
                String code =
                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()){
                                        String mobile = "+62" + getIntent().getStringExtra("mobile");
                                        databaseReference.child(mobile).child("id").setValue(mobile);
                                        sharedPreferences = getSharedPreferences("data_user", Context.MODE_PRIVATE);
                                        SharedPreferences.Editor editor = sharedPreferences.edit();
                                        editor.putString("id", mobile);
                                        editor.apply();
                                        Intent intent = new Intent(getApplicationContext(), UsernameActivity.class);
                                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                        startActivity(intent);
                                    }else {
                                        Toast.makeText(OTPActivity.this, "Kode Salah", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
        ...
        findViewById(R.id.txt_otp).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
